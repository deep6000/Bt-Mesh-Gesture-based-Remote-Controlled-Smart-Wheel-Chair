...
#define DI_ROW_DIRECTION    LCD_ROW_DIRECTION
#define DI_ROW_MOTORONOFF   LCD_ROW_MOTORONOFF
#define DI_ROW_IR           LCD_ROW_IR
#define DI_ROW_MOTORSPEED   LCD_ROW_MOTORSPEED
